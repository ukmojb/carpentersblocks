...
public class SpriteRegistry {
	...
	public static final ResourceLocation RESOURCE_UNCOVERED_SOLID 			= new ResourceLocation(CarpentersBlocks.MODID, "blocks/general/uncovered_solid");
	public static final ResourceLocation RESOURCE_UNCOVERED_FULL	 		= new ResourceLocation(CarpentersBlocks.MODID, "blocks/general/uncovered_full_frame");
	public static final ResourceLocation RESOURCE_UNCOVERED_QUARTERED 		= new ResourceLocation(CarpentersBlocks.MODID, "blocks/general/uncovered_quartered_frame");
	public static final ResourceLocation RESOURCE_UNCOVERED_OBLIQUE_POS     = new ResourceLocation(CarpentersBlocks.MODID, "blocks/slope/uncovered_oblique_pos");
	public static final ResourceLocation RESOURCE_UNCOVERED_OBLIQUE_NEG     = new ResourceLocation(CarpentersBlocks.MODID, "blocks/slope/uncovered_oblique_neg");
	public static final ResourceLocation RESOURCE_OVERLAY_FAST_GRASS_SIDE 	= new ResourceLocation(CarpentersBlocks.MODID, "blocks/overlay/overlay_fast_grass_side");
	public static final ResourceLocation RESOURCE_OVERLAY_HAY_SIDE 			= new ResourceLocation(CarpentersBlocks.MODID, "blocks/overlay/overlay_hay_side");
	public static final ResourceLocation RESOURCE_OVERLAY_SNOW_SIDE 		= new ResourceLocation(CarpentersBlocks.MODID, "blocks/overlay/overlay_snow_side");
	public static final ResourceLocation RESOURCE_OVERLAY_MYCELIUM_SIDE 	= new ResourceLocation(CarpentersBlocks.MODID, "blocks/overlay/overlay_mycelium_side");
	public static final ResourceLocation RESOURCE_TILE_BLANK 				= new ResourceLocation(CarpentersBlocks.MODID, "blocks/tile/blank");
