...
import com.wdcftgg.carpentersblocks.carpentersblocks.util.block.CollapsibleUtil;
...
public class BlockCarpentersCollapsibleBlock extends BlockFacing {
    ...
    private void smoothAdjacentCollapsibles(CbTileEntity cbTileEntity, int src_quadrant) {
        ...
        switch (src_quadrant) {
            case CollapsibleUtil.QUAD_XZNN:
                if (cbTileEntity_ZN != null && isSameOrientation(cbTileEntity, cbTileEntity_ZN)) {
                	util.setQuadDepth(cbTileEntity_ZN, CollapsibleUtil.QUAD_XZNP, depth);
                }
                if (cbTileEntity_XZNN != null && isSameOrientation(cbTileEntity, cbTileEntity_XZNN)) {
                	util.setQuadDepth(cbTileEntity_XZNN, CollapsibleUtil.QUAD_XZPP, depth);
                }
                if (cbTileEntity_XN != null && isSameOrientation(cbTileEntity, cbTileEntity_XN)) {
                	util.setQuadDepth(cbTileEntity_XN, CollapsibleUtil.QUAD_XZPN, depth);
                }
                break;
            case CollapsibleUtil.QUAD_XZNP:
                if (cbTileEntity_XN != null && isSameOrientation(cbTileEntity, cbTileEntity_XN)) {
                	util.setQuadDepth(cbTileEntity_XN, CollapsibleUtil.QUAD_XZPP, depth);
                }
                if (cbTileEntity_XZNP != null && isSameOrientation(cbTileEntity, cbTileEntity_XZNP)) {
                	util.setQuadDepth(cbTileEntity_XZNP, CollapsibleUtil.QUAD_XZPN, depth);
                }
                if (cbTileEntity_ZP != null && isSameOrientation(cbTileEntity, cbTileEntity_ZP)) {
                	util.setQuadDepth(cbTileEntity_ZP, CollapsibleUtil.QUAD_XZNN, depth);
                }
                break;
            case CollapsibleUtil.QUAD_XZPN:
                if (cbTileEntity_XP != null && isSameOrientation(cbTileEntity, cbTileEntity_XP)) {
                	util.setQuadDepth(cbTileEntity_XP, CollapsibleUtil.QUAD_XZNN, depth);
                }
                if (cbTileEntity_XZPN != null && isSameOrientation(cbTileEntity, cbTileEntity_XZPN)) {
                	util.setQuadDepth(cbTileEntity_XZPN, CollapsibleUtil.QUAD_XZNP, depth);
                }
                if (cbTileEntity_ZN != null && isSameOrientation(cbTileEntity, cbTileEntity_ZN)) {
                	util.setQuadDepth(cbTileEntity_ZN, CollapsibleUtil.QUAD_XZPP, depth);
                }
                break;
            case CollapsibleUtil.QUAD_XZPP:
                if (cbTileEntity_ZP != null && isSameOrientation(cbTileEntity, cbTileEntity_ZP)) {
                	util.setQuadDepth(cbTileEntity_ZP, CollapsibleUtil.QUAD_XZPN, depth);
                }
                if (cbTileEntity_XZPP != null && isSameOrientation(cbTileEntity, cbTileEntity_XZPP)) {
                	util.setQuadDepth(cbTileEntity_XZPP, CollapsibleUtil.QUAD_XZNN, depth);
                }
                if (cbTileEntity_XP != null && isSameOrientation(cbTileEntity, cbTileEntity_XP)) {
                	util.setQuadDepth(cbTileEntity_XP, CollapsibleUtil.QUAD_XZNP, depth);
                }
                break;
        }
    }
        ...
        if (!entityLivingBase.isSneaking()) {
            ...
            if (cbTileEntity != null) {
                ...
                if(cbTileEntity_XN != null && isSameOrientation(cbTileEntity, cbTileEntity_XN)) {
                    ...
                    hxn1 = utilXN.getQuadDepth(CollapsibleUtil.QUAD_XZPN);
                    hxn2 = utilXN.getQuadDepth(CollapsibleUtil.QUAD_XZPP);
                } else {
                ...
                if(cbTileEntity_XP != null && isSameOrientation(cbTileEntity, cbTileEntity_XP)) {
                    ...
                    hxp1 = utilXP.getQuadDepth(CollapsibleUtil.QUAD_XZNN);
                    hxp2 = utilXP.getQuadDepth(CollapsibleUtil.QUAD_XZNP);
                } else {
                ...
                if(cbTileEntity_ZN != null && isSameOrientation(cbTileEntity, cbTileEntity_ZN)) {
                    ...
                    hzn1 = utilZN.getQuadDepth(CollapsibleUtil.QUAD_XZNP);
                    hzn2 = utilZN.getQuadDepth(CollapsibleUtil.QUAD_XZPP);
                } else {
                ...
                if(cbTileEntity_ZP != null && isSameOrientation(cbTileEntity, cbTileEntity_ZP)) {
                    ...
                    hzp1 = utilZP.getQuadDepth(CollapsibleUtil.QUAD_XZNN);
                    hzp2 = utilZP.getQuadDepth(CollapsibleUtil.QUAD_XZPN);
                } else {
                ...
                util.setQuadDepth(cbTileEntity, CollapsibleUtil.QUAD_XZNN, height_XZNN);
                util.setQuadDepth(cbTileEntity, CollapsibleUtil.QUAD_XZNP, height_XZNP);
                util.setQuadDepth(cbTileEntity, CollapsibleUtil.QUAD_XZPP, height_XZPP);
                util.setQuadDepth(cbTileEntity, CollapsibleUtil.QUAD_XZPN, height_XZPN);
