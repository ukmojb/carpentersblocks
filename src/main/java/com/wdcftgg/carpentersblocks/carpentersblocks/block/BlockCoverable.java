...
import com.wdcftgg.carpentersblocks.carpentersblocks.util.attribute.AbstractAttribute;
...
import com.wdcftgg.carpentersblocks.carpentersblocks.util.protection.PlayerPermissions;
import com.wdcftgg.carpentersblocks.carpentersblocks.util.protection.ProtectedObject;
import com.wdcftgg.carpentersblocks.carpentersblocks.util.registry.ConfigRegistry;
import com.wdcftgg.carpentersblocks.carpentersblocks.util.states.factory.StateFactory;
...
/*        if (actionResult.playSound) {
    ...
    public boolean onChiselClick(CbTileEntity cbTileEntity, EnumAttributeLocation location, EnumHand hand, boolean leftClick) {
        ...
        if (StringUtils.isNullOrEmpty(designAdj) && EnumHand.MAIN_HAND.equals(hand)) {
            design = leftClick ? DesignHandler.getNext(DesignHandler.DesignType.CHISEL, design) : DesignHandler.getPrev(DesignHandler.DesignType.CHISEL, design);
        }
