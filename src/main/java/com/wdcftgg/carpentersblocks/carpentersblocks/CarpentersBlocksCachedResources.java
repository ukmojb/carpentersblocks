package com.wdcftgg.carpentersblocks.carpentersblocks;
...
public class CarpentersBlocksCachedResources extends DummyModContainer {
    ...
    private String resourceDir = FilenameUtils.normalizeNoEndSeparator(Minecraft.getMinecraft().gameDir.getAbsolutePath()) + File.separator + "mods" + File.separator + CarpentersBlocks.MODID.toLowerCase();
