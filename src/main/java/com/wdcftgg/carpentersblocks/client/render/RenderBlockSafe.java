...
import com.wdcftgg.carpentersblocks.client.model.ModelSafe;
import com.wdcftgg.carpentersblocks.client.model.ModelSafeOpen;
...
{
    private static final ResourceLocation TEXTURE_NORMAL = new ResourceLocation(CarpentersBlocks.MODID, "textures/model/safe.png");
    private static final ResourceLocation TEXTURE_NORMAL_OPEN = new ResourceLocation(CarpentersBlocks.MODID, "textures/model/safe_open.png");
    private static final ResourceLocation TEXTURE_LIGHT = new ResourceLocation(CarpentersBlocks.MODID, "textures/model/light.png");
    private static final ResourceLocation TEXTURE_HANDLE = new ResourceLocation(CarpentersBlocks.MODID, "textures/model/handle.png");
