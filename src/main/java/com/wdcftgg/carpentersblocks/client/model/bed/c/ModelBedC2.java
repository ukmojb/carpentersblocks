...
public class ModelBedC2 extends ModelBedBase {
    ...
    public ModelBedC2() {
        ...
        bb_main1.cubeList.add(new ModelBox(bb_main1, 8, 39, 6.0F, -2.0F, 6.0F, 2, 2, 2, 0.0F, true));
        bb_main1.cubeList.add(new ModelBox(bb_main1, 0, 21, -8.0F, -4.0F, -8.0F, 16, 2, 16, 0.0F, true));

        bb_main2.setRotationPoint(0.0F, 24.0F, 0.0F);
        bb_main2.cubeList.add(new ModelBox(bb_main2, 0, 0, -8.0F, -9.0F, -8.0F, 16, 5, 16, 0.0F, true));
    }
