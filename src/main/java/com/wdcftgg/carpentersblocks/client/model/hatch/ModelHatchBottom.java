...
public class ModelHatchBottom extends ModelHatchBase{
    private final ModelRenderer color;
    private final ModelRenderer bone;

    public ModelHatchBottom() {
        textureWidth = 64;
        textureHeight = 64;

        color = new ModelRenderer(this);
        color.setRotationPoint(8.0F, 24.0F, -8.0F);
        color.cubeList.add(new ModelBox(color, 0, 0, -16.0F, -2.0F, 0.0F, 16, 2, 16, 0.0F, false));

        bone = new ModelRenderer(this);
        bone.setRotationPoint(1.0F, 22.0F, -6.0F);
        ...
        bone.cubeList.add(new ModelBox(bone, 0, 18, -3.0F, -2.0F, -1.0F, 4, 1, 1, 0.0F, false));
    }
