...
public class ModelBarrierFour extends ModelBarrierBase {
    ...
    public ModelBarrierFour() {
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 16, 8, -1.0F, -7.0F, 2.0F, 2, 2, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 16, 0, -1.0F, -15.0F, 2.0F, 2, 2, 6, 0.0F, false));
